    ...
    return (
        <div>
            ...
            <section className="border-b-2 border-gray-900">
                ...
                <div className="-mt-9 flex justify-between items-end px-6">
                    <img 
                        src={user.avatar} 
                        alt={user.name} 
                ...
                <div className="px-6 mt-4">
                    ...
                    <div className="my-5 flex gap-6">
                        <div className="text-xl text-gray-500"><span className="text-white">80</span> Seguido</div>
                        <div className="text-xl text-gray-500"><span className="text-white">759</span> Seguidores</div>
                    </div>
                </div>
            </section>
            <ProfileFeed />
