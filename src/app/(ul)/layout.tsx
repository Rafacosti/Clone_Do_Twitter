...
import { RecommedationArea } from "@/components/ui/recommedation-area";
...
export default function Layout ({ children }: Props ) {
    return (
        <main className="min-h-screen flex justify-center mx-auto max-w-7xl">
            ...
            <aside className="hidden lg:flex flex-col gap-6 sticky top-0 h-fit w-96 py-6 px-3 border-l-2 border-gray-900">
